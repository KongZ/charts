...
| `graylog.elasticsearch.request_timeout`        | Global request timeout for Elasticsearch requests based on a best-effort to restrict the runtime of Elasticsearch operations.                         | `1m`                              |

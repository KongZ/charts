...
| `graylog.metrics.proxy_enabled`                | If true, configure a proxy server to download the prometheus metrics plugin                                                                           | `false`                           |
| `graylog.metrics.proxy_host`                   | The proxy server that should be used to download the plugin                                                                                           | `http://your.proxy.host:8080`     |
